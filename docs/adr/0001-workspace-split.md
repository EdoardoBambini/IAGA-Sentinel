...
- `iaga-sentinel-dictum` for the Dictum parser, validator, and evaluator.
...
The split makes public APIs easier to review and lets verification tools reuse receipt logic without pulling in the full server. It also makes feature flags clearer: ML, Postgres, plugin attestation, Dictum WASM, and receipt export can be enabled where they matter.
